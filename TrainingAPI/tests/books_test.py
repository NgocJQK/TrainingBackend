...
class BooksTests(unittest.TestCase):
    ...
    def test_register(self):
        user = {"username": "ngochmadmin", "password": "123123"}
    ...
    def test_login(self):
        ...
        user = {"username": "ngochm", "password": "123123"}
    ...
    def test_create_books(self):
        ...
        book = {
            "title": "Nhân sinh không luyến tiếc",
            "authors": ["Hoàng Minh Ngọc"],
        ...
        data = json.loads(response.text) 
        books = data["books"]
        self.assertTrue(any(b["title"] == "Ngochm" for b in books))
    ...
    def test_update_books(self):
        ...
        headers = self.test_login()
        update_title = "Nhân sinh không luyến tiếc part 2"
